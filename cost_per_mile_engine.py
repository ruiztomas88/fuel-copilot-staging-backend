...
class CostBreakdown:
    ...
    def __post_init__(self):
        ...
        if self.total_cost_per_mile > 0:
            self.fuel_percent = (self.fuel_cost_per_mile / self.total_cost_per_mile) * 100
            self.maintenance_percent = (self.maintenance_cost_per_mile / self.total_cost_per_mile) * 100
            self.tire_percent = (self.tire_cost_per_mile / self.total_cost_per_mile) * 100
            self.depreciation_percent = (self.depreciation_per_mile / self.total_cost_per_mile) * 100
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "comparisons": {
                ...
                "vs_industry_benchmark_percent": round(self.vs_industry_benchmark_percent, 1),
...
class CostPerMileEngine:
    ...
    def analyze_truck_costs(
        ...
        if fleet_avg_cpm and fleet_avg_cpm > 0:
            vs_fleet = ((breakdown.total_cost_per_mile - fleet_avg_cpm) / fleet_avg_cpm) * 100
        ...
        if previous_period_cpm and previous_period_cpm > 0:
            trend_change = ((breakdown.total_cost_per_mile - previous_period_cpm) / previous_period_cpm) * 100
            if trend_change < -5:
    ...
    def analyze_fleet_costs(
        ...
        benchmark = INDUSTRY_BENCHMARKS["cost_per_mile_total"]
        vs_benchmark = ((fleet_breakdown.total_cost_per_mile - benchmark) / benchmark) * 100
        ...
        return FleetCostSummary(
            ...
            worst_cost_per_mile=worst.cost_breakdown.total_cost_per_mile if worst else 0,
    ...
    def generate_cost_report(
        ...
        if not summary:
            return {
                "status": "error",
                "message": "No data available for cost analysis"
            }
...
def calculate_speed_cost_impact(
    ...
    return {
        ...
        "recommendation": f"Reducing speed from {avg_speed_mph:.0f} to 62 mph would save ${monthly_cost_impact:.2f}/month" if mph_over > 2 else "Speed is within optimal range"
    }
...
if __name__ == "__main__":
    ...
    # Sample truck data
    test_trucks = [
        {"truck_id": "JC1282", "miles": 8500, "gallons": 1400, "engine_hours": 280, "avg_mpg": 6.07},
        {"truck_id": "RT9127", "miles": 7200, "gallons": 1300, "engine_hours": 250, "avg_mpg": 5.54},
        {"truck_id": "FM9838", "miles": 6800, "gallons": 1150, "engine_hours": 230, "avg_mpg": 5.91},
        {"truck_id": "SG5760", "miles": 9100, "gallons": 1600, "engine_hours": 300, "avg_mpg": 5.69},
    ]
