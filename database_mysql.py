...
def get_loss_analysis_v2(days_back: int = 1) -> Dict[str, Any]:
    ...
    for truck in trucks:
        ...
        if truck["total_miles"] > 0:
            ...
            if expected_consumption > 0:
                loss_pct = (loss_gal / expected_consumption) * 100
                if loss_pct > 30:
                    severity_score += 30
                elif loss_pct > 20:
                    severity_score += 20
        ...
        if primary == "SOBRECALENTAMIENTO":
            severity_score += 30  # Mechanical = urgent
        elif primary in ["RALENTÍ EXCESIVO", "RPM ELEVADAS"]:
        ...
        if severity_score >= 70:
            ...
            truck["severity_color"] = "#DC2626"
            truck["action_urgency"] = "IMMEDIATE (24h)"
        elif severity_score >= 50:
            truck["severity_v2"] = "HIGH"
            truck["severity_color"] = "#F97316"
            truck["action_urgency"] = "THIS WEEK"
        elif severity_score >= 30:
            truck["severity_v2"] = "MEDIUM"
            truck["severity_color"] = "#F59E0B"
            truck["action_urgency"] = "THIS MONTH"
        else:
    ...
    if altitude_loss_gal > 2:
        # This is environmental, harder to fix but worth noting
