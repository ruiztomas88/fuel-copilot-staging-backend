...
class LSTMMaintenancePredictor:
    ...
    def __init__(
        ...
        logger.info(f"Initialized LSTM Predictor (seq_length={sequence_length}, features={features})")
    ...
    def prepare_sequences(
        ...
        for truck_id in df['truck_id'].unique():
            ...
            for i in range(len(features_scaled) - self.sequence_length):
                ...
                if labels is not None:
                    ...
                    end_date = truck_data.iloc[i + self.sequence_length]['timestamp_utc']
                    truck_labels = labels[
                    ...
                    if len(truck_labels) == 0:
                        ...
                        days_until = (truck_labels.iloc[0]['timestamp_utc'] - end_date).days
                        if days_until <= 7:
        ...
        logger.info(f"Prepared {len(X)} sequences from {df['truck_id'].nunique()} trucks")
