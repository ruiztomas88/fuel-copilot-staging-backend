...
CREATE INDEX IF NOT EXISTS idx_fuel_events_truck_id 
...
CREATE INDEX IF NOT EXISTS idx_fuel_events_truck_type_time 
...
CREATE INDEX IF NOT EXISTS idx_fuel_metrics_truck_time 
ON fuel_metrics(truck_id, timestamp_utc);

-- Time-based queries
CREATE INDEX IF NOT EXISTS idx_fuel_metrics_timestamp 
ON fuel_metrics(timestamp_utc);

-- Idle detection queries
CREATE INDEX IF NOT EXISTS idx_fuel_metrics_idle 
...
CREATE INDEX IF NOT EXISTS idx_sensor_data_truck_time 
...
-- Truck-specific DTCs
CREATE INDEX IF NOT EXISTS idx_dtc_events_truck 
ON dtc_events(truck_id);

-- Active DTCs (dashboard filtering)
CREATE INDEX IF NOT EXISTS idx_dtc_events_active 
ON dtc_events(is_active);

-- Severity filtering
CREATE INDEX IF NOT EXISTS idx_dtc_events_severity 
ON dtc_events(severity);

-- Time-based queries
CREATE INDEX IF NOT EXISTS idx_dtc_events_timestamp 
ON dtc_events(timestamp);

-- Composite: truck + active + severity (common dashboard query)
CREATE INDEX IF NOT EXISTS idx_dtc_events_truck_active_severity 
ON dtc_events(truck_id, is_active, severity);

-- Composite: active + severity + time (alerts)
CREATE INDEX IF NOT EXISTS idx_dtc_events_active_severity_time 
...
CREATE INDEX IF NOT EXISTS idx_truck_sensors_cache_truck 
ON truck_sensors_cache(truck_id);

-- Freshness check
CREATE INDEX IF NOT EXISTS idx_truck_sensors_cache_timestamp 
ON truck_sensors_cache(timestamp);

-- Data age for staleness detection
CREATE INDEX IF NOT EXISTS idx_truck_sensors_cache_age 
...
CREATE INDEX IF NOT EXISTS idx_refuel_events_truck 
ON refuel_events(truck_id);

-- Time-based queries
CREATE INDEX IF NOT EXISTS idx_refuel_events_timestamp 
ON refuel_events(timestamp);

-- Composite: truck + time
CREATE INDEX IF NOT EXISTS idx_refuel_events_truck_time 
ON refuel_events(truck_id, timestamp);

-- Refuel type filtering
CREATE INDEX IF NOT EXISTS idx_refuel_events_type 
...
CREATE INDEX IF NOT EXISTS idx_maintenance_events_truck 
ON maintenance_events(truck_id);

-- Time-based queries
CREATE INDEX IF NOT EXISTS idx_maintenance_events_timestamp 
...
-- Composite: truck + time
CREATE INDEX IF NOT EXISTS idx_maintenance_events_truck_time 
...
CREATE INDEX IF NOT EXISTS idx_trips_truck_start 
...
-- Truck-specific GPS
CREATE INDEX IF NOT EXISTS idx_gps_data_truck 
ON gps_data(truck_id);

-- Time-based queries
CREATE INDEX IF NOT EXISTS idx_gps_data_timestamp 
ON gps_data(timestamp);

-- Composite: truck + time
CREATE INDEX IF NOT EXISTS idx_gps_data_truck_time 
