...
def validate_column_name(column_name: str) -> str:
    ...
    if column_name.lower() in sql_keywords:
        raise SQLInjectionError(f"Column name '{column_name}' is a SQL keyword")
...
def safe_count(table_name: str, where: Optional[str] = None) -> Tuple[str, List]:
    """
...
if __name__ == "__main__":
    ...
    try:
        query, params = safe_select(
            "fuel_metrics", columns=["truck_id", "mpg_current"], limit=10
        )
