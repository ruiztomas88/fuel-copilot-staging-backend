...
from database_mysql import calculate_fleet_health_score, haversine_distance
...
def test_efficiency_rating_algorithm():
    ...
    for avg_mpg, expected_rating, description in test_cases:
        ...
        print(
            f"   MPG: {avg_mpg:.1f} | Baseline: {baseline_mpg:.1f} | "
