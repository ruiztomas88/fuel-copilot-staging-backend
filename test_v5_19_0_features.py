...
try:
    ...
    if 'enhanced_insights' in analysis and analysis['enhanced_insights']:
        ...
        for i, insight in enumerate(analysis['enhanced_insights'][:3], 1):  # Show top 3
            ...
            print(f"         Implementation Cost: ${roi['implementation_cost_usd']:,.2f}")
    ...
    if 'action_summary' in analysis:
        ...
        print(f"\n   📋 Action Summary:")
        print(f"      Total Annual Savings: ${action['total_potential_annual_savings_usd']:,.2f}")
        print(f"      Implementation Cost: ${action['total_implementation_cost_usd']:,.2f}")
    ...
    if analysis['trucks']:
        ...
        print(f"      Total Loss: {truck['total_loss']['gallons']:.1f} gal (${truck['total_loss']['usd']:.2f})")
